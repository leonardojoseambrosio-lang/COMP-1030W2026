    ...
    public class Wheel
    {
        ...
        public Wheel(double diameter)
        {
            ...
            if (diameter < 10 || diameter > 100)
            {
                ...
                throw new ArgumentOutOfRangeException(nameof(diameter), "Diameter of a new wheel object must be between 10 and 100.");
        ...
        public double Roll(double numTimes)
        {
            ...
            double distanceTravelled = this.Diameter * Math.PI * numTimes;
