...
namespace Module4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (timeToWakeUp)
            {
                Console.WriteLine($"It's {hour} O' clock and it is time to wake up!");
            }
            else
            {
                Console.WriteLine($"It's {hour} O' clock. Go back to sleep.");
            }
            ...
            if (hour != 6)
                Console.WriteLine("It is not dinner time!");
            ...
            if (calculateSum == 0.3)
            Console.WriteLine("It's true that 0.1 + 0.2 equals 0.3");
            else
            ...
            if (hour < 12 ^ hour >= 18)
                Console.WriteLine("It's not afternoon.");
        }
    }
}