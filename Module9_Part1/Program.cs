    ...
    static void Main(string[] args)
    {
        ...
        void myMethod()
        {
            ...
            void myMethod2(string whatever)
            {
                ...
                Console.WriteLine($"The method myMethod2 was called with the following argument: {whatever}");
            ...
            {
                int numChar = mySentence.Length;
                return numChar;

            }

            // STEP 8a: Prompt the user to enter a sentence
            Console.WriteLine("Type a short sentence and this program will count the number of characters for you");
            ...
            Console.WriteLine($"There are {CharsInSentence} cjaracters in the sentence.");
